...
examArray.getSerie('SEQ_run1$').addStim(stimdirs,'MRI_Motor_run01_SPM','SEQ_run1',1)
examArray.getSerie('SEQ_run2$').addStim(stimdirs,'MRI_Motor_run02_SPM','SEQ_run2',1)
